...
public class CampingInterface extends ScriptInterface {
    public CampingInterface(WebView view, PurchaseConfig config) {
        super(view, config);
    }
...
//        }
    ...
    public void closePopup() {
        runScript("document.querySelector('.btn_layerClose').click()");
    }
